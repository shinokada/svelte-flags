...
<p>You can create a custom default icon, by using <Code>IconSolid</Code> or <Code>IconOutline</Code>:</p>
...
<p>Here, we import the <Code>MyIcon</Code> component and the <Code>Us</Code> and <Code>Ca</Code> icons. By passing the icons to the <Code>icon</Code> prop of MyIcon, you apply the default configuration to the icon.</p>