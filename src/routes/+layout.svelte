...
<MetaTags
  ...
  openGraph={{
    type: 'website',
    url: 'https://svelte-flags.vercel.app/',
    title: "Svelte Flags",
    description: "Flag icon set for Svelte",
    images: [{ url: 'https://open-graph-vercel.vercel.app/api/svelte-flags', width: 1200, height: 630, alt: "Svelte Flags" }],
    site_name: 'Svelte Flags'
  }}
  twitter={{
    handle: '@shinokada',
    ...
    title: "Svelte Flags",
    description: "Flag icon set for Svelte",
    image:'https://open-graph-vercel.vercel.app/api/svelte-flags',
    imageAlt: "Svelte Flags"
  }} />
  
<header class="flex-none w-full mx-auto bg-white dark:bg-stone-900">
  <Navbar color="default" fluid let:hidden let:toggle class="dark:bg-stone-900 ">
    <NavBrand href="/">
    ...
    <NavUl {hidden} {divClass} {ulClass} on:click={() => setTimeout(toggle, 1)} 
      ...
      <NavLi class="lg:px-2 lg:mb-0" href="https://github.com/shinokada/svelte-flags">GitHub</NavLi>
...
<Footer footerType="logo" class="dark:bg-stone-900">
  <div class="sm:flex sm:items-center sm:justify-between">
    <FooterBrand
    href="https://svelte-flags.vercel.app/"
    name="Svelte Flags" classSpan="text-primary-700 dark:text-primary-500"
  />
  <FooterLinkGroup ulClass="flex flex-wrap items-center mt-3 text-sm text-gray-500 dark:text-gray-400 sm:mt-0">
    <FooterLink href="/">Home</FooterLink>
    <FooterLink href="/icons">Icons</FooterLink>
    <FooterLink href="https://github.com/shinokada/svelte-flags/blob/main/LICENSE">Licensing</FooterLink>
    <FooterLink href="https://github.com/shinokada/svelte-flags/">GitHub</FooterLink>
