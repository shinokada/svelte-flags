...
<MetaTags
  ...
  openGraph={{
    ...
    images: [
      {
        url: 'https://open-graph-vercel.vercel.app/api/svelte-flags',
        width: 1200,
        height: 630,
        alt: 'Svelte Flags'
      }
    ],
    siteName: 'Svelte Flags'
  }}
  twitter={{
    handle: '@shinokada',
...
<div class="max-h-screen overflow-auto relative w-full" id="svelte">
  <header
    class="sticky top-0 z-40 flex-none w-full mx-auto bg-white border-b border-gray-200 dark:border-gray-600 dark:bg-stone-900"
  >
...
<Footer footerType="logo" class="dark:bg-stone-900">
  <div class="sm:flex sm:items-center sm:justify-between">
    ...
    >
      ...
      <FooterLink href="https://github.com/shinokada/svelte-flags/blob/main/LICENSE"
